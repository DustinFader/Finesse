...
import { Table, TableHeader, TableBody, TableRow, TableCell, TableColumn, getKeyValue, Input, Button, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter,useDisclosure, Checkbox, Link } from "@nextui-org/react";
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalFooter>
                <Button color="primary" onPress={onClose} type="submit" form="addPayment">
                  Add
                </Button>
              </ModalFooter>
            </>
